...
export AS_PROJECT_PATH := C:/projects/ProjetoPadraoSegunda
export AS_PROJECT_NAME := ProjetoPadraoSegunda
export AS_SYSTEM_PATH := C:/BrAutomation/AS/System
export AS_VC_PATH := C:/BrAutomation/AS41/AS/VC
export AS_TEMP_PATH := C:/projects/ProjetoPadraoSegunda/Temp
export AS_CONFIGURATION := Config1
export AS_BINARIES_PATH := C:/projects/ProjetoPadraoSegunda/Binaries
...
export WIN32_AS_PROJECT_PATH := C:\\projects\\ProjetoPadraoSegunda
export WIN32_AS_SYSTEM_PATH := C:\\BrAutomation\\AS\\System
export WIN32_AS_VC_PATH := C:\\BrAutomation\\AS41\\AS\\VC
export WIN32_AS_TEMP_PATH := C:\\projects\\ProjetoPadraoSegunda\\Temp
export WIN32_AS_BINARIES_PATH := C:\\projects\\ProjetoPadraoSegunda\\Binaries
...
ProjectMakeFile:
	...
	@$(AS_GNU_BIN_PATH)/mingw32-make.exe -r -f 'C:/projects/ProjetoPadraoSegunda/Temp/Objects/$(AS_CONFIGURATION)/X20CP1583/#cpu.mak' -k 
